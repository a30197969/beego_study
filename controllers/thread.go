...
//  ThreadController operations for Thread
type ThreadController struct {
	beego.Controller
}

// URLMapping ...
func (c *ThreadController) URLMapping() {
...
func (c *ThreadController) Post() {
	...
	if _, err := models.AddThread(&v); err == nil {
...
func (c *ThreadController) GetAll() {
	...
	l, err := models.GetAllThread(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
func (c *ThreadController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.ParseInt(idStr, 0, 64)
	v := models.Thread{Threadid: id}
	json.Unmarshal(c.Ctx.Input.RequestBody, &v)
	if err := models.UpdateThreadById(&v); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
